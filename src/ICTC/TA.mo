...
module {
    ...
    public class TA(limitNum: Nat, autoClearTimeout: Int, _this: Principal, localCall: LocalCall, /*localCallAsync: LocalCallAsync,*/ agentCallback: ?AgentCallback, taskCallback: ?Callback) {
